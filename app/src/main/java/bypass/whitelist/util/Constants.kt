...
object PrefsKeys {
    ...
    const val ROUTING_PROXY_RULES = "routing_proxy_rules"
    const val ROUTING_DIRECT_RULES = "routing_direct_rules"
    const val ROUTING_BLOCK_RULES = "routing_block_rules"
    const val SPLIT_ROUTING_FORCE = "split_routing_force"
